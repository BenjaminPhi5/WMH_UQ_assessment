...
# model
from trustworthai.run.model_load.load_evidential import load_evidential
...
def main(args):
    ...
    model_raw, loss, val_loss = load_evidential(args)
    ...
    model = StandardLitModelWrapper(model_raw, loss, val_loss=val_loss, logging_metric=lambda : None,
