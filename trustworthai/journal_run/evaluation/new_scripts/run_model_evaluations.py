...
def execute_model_evaluation(hyperparameters_file, args):
    ...
    print(script)
    command = ['python', script, f'--repo_dir={args.repo_dir}', f'--result_dir={args.result_dir}', f'--eval_split={args.eval_split}', f'--ckpt_dir={args.ckpt_dir}', f'--dataset={args.dataset}', f'--overwrite={args.overwrite}', f'--uncertainty_type={args.uncertainty_type}', f'--eval_sample_num={args.eval_sample_num}']
