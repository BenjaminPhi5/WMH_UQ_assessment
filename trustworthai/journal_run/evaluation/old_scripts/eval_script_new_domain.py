...
def generate_means_and_samples_SSN_Ens(splits=6, dataset_stride=2, temp=1, num_samples=10):
    ...
    for split in range(splits):
        ...
        train_ds_clin, val_ds_clin, test_ds_clin = load_data(dataset="chal", test_proportion=0.15, validation_proportion=0.15, seed=3407, empty_proportion_retained=0.1, batch_size=32, dataloader2d_only=False, dataset3d_only=True,
             cross_validate=False, cv_split=None, cv_test_fold_smooth=1)
        
        test_ds_clin = ConcatDataset([train_ds_clin, val_ds_clin, test_ds_clin])
