...
def normalize_brain(image, mask, lower_percentile=0, upper_percentile=100):
    ...
    if lower_percentile > 0 or upper_percentile < 100:
        print("normalizing with percentiles: ", lower_percentile, upper_percentiles)
...
def normalize(img_path, mask_path, out_path, lower_percentile=0, upper_percentile=100, background=0.0):
