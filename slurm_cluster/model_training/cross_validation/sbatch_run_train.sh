...
# Commented out cause they have so many partitions now
...
result_path=/disk/scratch_big/${USER}/results/cross_validated_models
result_dest_path=/home/${USER}/ipdis/results/cross_validated_models
